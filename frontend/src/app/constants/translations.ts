export const translations = {
  ru: {
    ...
    homeTitle: 'Usta International - Инженерное сообщество',
    homeDescription:
    ...
    errorPageDescription:
      'Страница недоступна. Попробуйте вернуться на главную страницу.',
    errorLink: 'На Главную',
  },
  'en-us': {
    home: 'Home',
    services: 'Services',
    ...
    area: 'Area',
    allProjects: 'See all',
    homeTitle: 'Usta International - Engineering Community',
    homeDescription:
    ...
    errorPageDescription:
      'The page is not available. Try going back to the home page.',
    errorLink: 'Go Home',
  },
};
